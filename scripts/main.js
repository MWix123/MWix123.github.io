...
galleryDescriptions = ["<h3>Maze Generator</h3><p>This webpage randomly generates a maze of size 16x16, 32x32 or 64x64 based on the user's choice. The generated maze can also be downloaded as a PDF by clicking on the appropriate button.</p>",
"<h3>Master Calculator</h3><p>Master Calculator solves mathematical equations of college level difficulty while providing a clean and intuitive interface for users. It formats all input and output in a LaTex format so as to improve readability.</p>"];
